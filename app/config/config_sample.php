...
$app->set('flight.base_url_assets', '/Racine_prod_the/Gestion_prod_the/public/assets'); 
$app->set('flight.base_url', '/Racine_prod_the/Gestion_prod_the');// if this is in a subdirectory, you'll need to change this
